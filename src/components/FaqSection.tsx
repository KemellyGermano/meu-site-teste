...
//   return (
//     <section className="text-white border-t border-white/10 py-24 md:px-16">
//       <div className="max-w-6xl mx-auto">
//         {/* Cabeçalho */}
//         <div className="flex flex-col md:flex-row md:items-start md:justify-between mb-16">
//           <div>
//             <span className="text-yellow-400 text-sm font-medium bg-yellow-300/10 border border-yellow-400/40 px-3 py-1 rounded-sm inline-block mb-6">
//               FAQ
//             </span>
//             <h2 className="text-5xl font-light mt-4">Perguntas frequentes</h2>
//           </div>

//           <p className="text-gray-400 text-base mt-8 md:mt-0 md:w-[40%] leading-relaxed">
...
//                 <div className="text-yellow-400 transition-transform duration-300">
//                   {openIndex === index ? (
//                     <Minus size={20} />
//                   ) : (
//                     <Plus size={20} />
