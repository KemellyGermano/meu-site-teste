...
const FaqSection: React.FC = () => {
  ...
  return (
    <section className="text-white border-t border-white/10 py-24 px-6 md:px-16">
      <div className="max-w-6xl mx-auto">
        {/* Cabeçalho */}
        <div className="flex flex-col md:flex-row md:items-start md:justify-between mb-16">
          <div>
            <span className="bg-yellow-300/10text-xs text-yellow-500 bg-yellow-300/10 border border-yellow-600/25 px-5 py-1 rounded-sm">
              FAQ
            </span>
